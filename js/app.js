(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-tips__slider")) new core(".slider-tips__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("products__more")) {
                e.preventDefault();
                const hiddenBlocks = document.querySelectorAll(".products__item.hidden");
                if (hiddenBlocks) hiddenBlocks.forEach((block => {
        ...
        if (furniture && !isMobile.any()) {
            document.querySelector(".furniture__items");
            ...
            function setMouseGalleryStyle() {
                ...
                furniture.style.cssText = `transform: translate3d(${-position}px, 0, 0);`;
